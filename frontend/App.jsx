...
//   // A safe reference to track the ID of the sentence currently being spoken
...
//   // THE ROOT FIX: Bulletproof Flowing Audio API
//   useEffect(() => {
//     let recognition;
//     let isStopped = false; 
...
//           // Updates the current live bubble
//           broadcastCaption(currentVoiceIdRef.current, transcript.trim().toUpperCase(), 'voice');
//         }

//         if (isFinal) {
//           // Sentence is finished! Generate a new ID for the next sentence
...
//     };
//     // By ignoring exhaustive-deps here, we guarantee React never interrupts the microphone!
...
//       <div style={{
//         position: 'absolute', bottom: '100px', left: '20px', display: 'flex', flexDirection: 'column', 
//         gap: '8px', zIndex: 1000, pointerEvents: 'none', maxWidth: '80%'
//       }}>
//         {captions.map(c => (
//           <div key={c.id} style={{
//             backgroundColor: 'rgba(15, 23, 42, 0.85)', padding: '10px 18px', borderRadius: '12px', 
//             color: 'white', fontSize: '18px', backdropFilter: 'blur(5px)', border: '1px solid rgba(255,255,255,0.1)',
//             boxShadow: '0 4px 6px -1px rgba(0,0,0,0.3)', animation: 'fadeIn 0.3s ease-in-out'
//           }}>
//             <span style={{ fontWeight: 'bold', color: c.type === 'sign' ? '#4ade80' : '#3b82f6', marginRight: '8px' }}>
//               {c.name}:
//             </span>
...
//   const [room, setRoom] = useState('ProjectDemo'); 
...
//       }}>
//         <div style={{
//           backgroundColor: 'rgba(30, 41, 59, 0.7)', padding: '50px', borderRadius: '20px',
//           boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)', backdropFilter: 'blur(10px)',
//           border: '1px solid rgba(255, 255, 255, 0.1)', display: 'flex', flexDirection: 'column',
//           alignItems: 'center', gap: '25px', width: '100%', maxWidth: '400px'
//         }}>
//           <div style={{ textAlign: 'center' }}>
//             <h1 style={{ margin: '0 0 10px 0', fontSize: '32px', fontWeight: '800', background: '-webkit-linear-gradient(45deg, #4ade80, #3b82f6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
//               Sign-Meet
//             </h1>
//             <p style={{ margin: 0, color: '#94a3b8', fontSize: '14px' }}>AI-Powered Accessible Meetings</p>
//           </div>
//           <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '15px' }}>
//             <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Your Display Name" style={{ padding: '15px', borderRadius: '10px', border: '1px solid #334155', backgroundColor: '#0f172a', color: 'white', fontSize: '16px', outline: 'none' }} />
//             <input value={room} onChange={(e) => setRoom(e.target.value)} placeholder="Meeting Room ID" style={{ padding: '15px', borderRadius: '10px', border: '1px solid #334155', backgroundColor: '#0f172a', color: 'white', fontSize: '16px', outline: 'none' }} />
//           </div>
//           <button onClick={joinRoom} style={{ width: '100%', padding: '15px', borderRadius: '10px', border: 'none', backgroundColor: '#4ade80', color: '#064e3b', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', boxShadow: '0 4px 6px -1px rgba(74, 222, 128, 0.2)' }}>
//             Join Meeting
//           </button>
//         </div>
//       </div>
...
//   return (
//     <div style={{ position: 'relative', height: '100vh', width: '100vw', backgroundColor: '#111' }}>
...
//         /* THE ROOT FIX FOR STACKING: flex-direction instead of flexDirection */
...
//       {/* THE FIX: Hero Section (Image Left, Content Right) */}
//       <section className="fade-up hero-row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '160px 5% 100px 5%', maxWidth: '1200px', margin: '0 auto', gap: '50px' }}>
        
//         {/* Left Side: Floating Image */}
//         <div style={{ flex: 1, display: 'flex', justifyContent: 'center', animation: 'float 6s ease-in-out infinite' }}>
//           <img 
//             src="/images/hero.png" 
//             alt="Sign-Meet Hero" 
...
//         {/* Right Side: Text & Button Content */}
//         <div className="content" style={{ flex: 1.2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left', boxSizing: 'border-box' }}>
//           <h1 style={{ fontSize: '56px', color: '#111827', lineHeight: '1.2', marginBottom: '20px' }}>
//             Real Time <br/><span style={{ color: '#2563EB' }}>Sign-Meet</span>
//           </h1>
//           <p style={{ fontSize: '20px', lineHeight: '1.6', marginBottom: '40px', color: '#4B5563', maxWidth: '500px' }}>
...
//               {/* DETAILS FORCED TO THE BOTTOM BY FLEX-DIRECTION COLUMN */}
...
// // ==========================================
// // 2. THE AI MEETING BRIDGE (Existing Logic)
// // ==========================================
// function AIBridge({ userName }) {
//   const room = useRoomContext();
//   const { localParticipant, isCameraEnabled, isMicrophoneEnabled } = useLocalParticipant();
...
// // ==========================================
// // 3. THE MAIN APP (Routing & Meeting UI)
// // ==========================================
// export default function App() {
...
//   if (!token) {
//     return (
//       <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', width: '100vw', backgroundColor: '#0f172a', backgroundImage: 'radial-gradient(circle at 50% 50%, #1e293b 0%, #0f172a 100%)', color: 'white', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'absolute', top: 0, left: 0, margin: 0, padding: 0 }}>
        
//         <button onClick={() => setCurrentPage('landing')} style={{ position: 'absolute', top: '30px', left: '30px', background: 'transparent', border: '1px solid rgba(255,255,255,0.2)', color: 'white', padding: '8px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: '600' }}>
//           ← Back to Home
//         </button>

//         <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.7)', padding: '50px', borderRadius: '20px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '25px', width: '100%', maxWidth: '400px' }}>
//           <div style={{ textAlign: 'center' }}>
//             <h1 style={{ margin: '0 0 10px 0', fontSize: '32px', fontWeight: '800', background: '-webkit-linear-gradient(45deg, #4ade80, #3b82f6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Sign-Meet</h1>
//             <p style={{ margin: 0, color: '#94a3b8', fontSize: '14px' }}>AI-Powered Accessible Meetings</p>
//           </div>
//           <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '15px' }}>
//             <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Your Display Name" style={{ padding: '15px', borderRadius: '10px', border: '1px solid #334155', backgroundColor: '#0f172a', color: 'white', fontSize: '16px', outline: 'none' }} />
